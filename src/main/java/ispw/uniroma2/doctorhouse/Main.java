...
public class Main extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        specialtyDaoFactory.setConnection(ConnectionFactory.getConnection());
        SpecialtyDao specialtyDao = specialtyDaoFactory.create();
        ShiftDaoFactory shiftDaoFactory = new ShiftDatabaseFactory();
        shiftDaoFactory.setConnection(ConnectionFactory.getConnection());
        ...
        officeDaoFactory.setConnection(ConnectionFactory.getConnection());
        UserDaoFactory userDaoFactory = new UserDatabaseFactoryImpl();
        userDaoFactory.setConnection(ConnectionFactory.getConnection());
        ...
        RequestDaoFactory requestDaoFactory = new RequestDaoFactoryImpl();
        requestDaoFactory.setConnection(ConnectionFactory.getConnection());
        patientFactory.setRequestDaoFactory(requestDaoFactory);
        ResponseDaoFactory responseDaoFactory = new ResponseDaoFactoryImpl();
        responseDaoFactory.setConnection(ConnectionFactory.getConnection());
